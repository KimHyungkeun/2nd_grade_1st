...
public class RobotParts extends JComponent implements LayoutManager{
	...
	public RobotParts(int clickcount,int parX, int parY, boolean what)
	{
		//thread = new TheThread();
		setPoints(parX, parY, what);
		imageicon = new ImageIcon("SpongeBob.jpg");
